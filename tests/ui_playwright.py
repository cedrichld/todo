...
async def main():
    async with async_playwright() as p:
        ...
        sub = by_text(tree(), 'Update the Racer')
        check('Today shows the parent task before a sub-task', 'Orientation 1 time' in (await pg.locator(f'.node[data-id="{sub["id"]}"] > .row > .crumb').text_content()))
