...
async def main():
    async with async_playwright() as p:
        ...
        check('clicking the preview expands the full note', 'ask about the deadline' in await pg.locator(f'.node[data-id="{first["id"]}"] > .note > .note-text').input_value())
        await pg.keyboard.press('End'); await pg.keyboard.type(' and budget'); await pg.wait_for_timeout(700)
